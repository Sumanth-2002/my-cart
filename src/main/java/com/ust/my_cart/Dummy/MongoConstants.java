...
public class MongoConstants {
    ...
    public static final String SAVE_ITEM = BASE_URI + "item&operation=save";
    ...
    public static final String UPDATE_ITEM = BASE_URI + "item&operation=update";
    public static final String REMOVE_ITEM = BASE_URI + "item&operation=remove";

    // === CATEGORY Collection Operations ===
    public static final String SAVE_CATEGORY = BASE_URI + "category&operation=save";
